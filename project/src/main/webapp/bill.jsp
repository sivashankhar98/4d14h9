...
try
{
	...
	{
%>
<h3>Online shopping Bill (Red Team-Mobiles)</h3>
<hr>
...
<h3>Product Details</h3>
  ...
  <%
  ResultSet rs1=st.executeQuery("select * from carts inner join products where carts.product_id and carts.email='"+email+"' and carts.status='bill'");
  while(rs1.next())
  {
	  sno=sno+1;
  %>
