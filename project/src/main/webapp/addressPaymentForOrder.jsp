...
%>
          ...
          <tr>
          <th scope="col"></th>
            <th scope="col" style="background-color: yellow;">Total: <i class="fa fa-inr"><a href="myCart.jsp"><i class="fas fa-arrow-circle-left"> Back</i></a></i><%out.println(total); %> </th>
          </tr>
        </thead>
        <thead>
          <tr>
...
<h3>Select way of Payment</h3>
 ...
 <option value="Cash on delivery(COD)">Online Payment</option>
 
 </select>
</div>

<div class="right-div">
<h3>Pay online on this red-mobiles@pay.com</h3>
